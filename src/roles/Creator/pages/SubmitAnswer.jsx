    ...
    >
      ...
      {confirmSubmit && (
        ...
        <div className="absolute top-0 left-0 w-screen h-screen bg-[rgba(255,255,255,0.2)] dark:bg-[rgba(0,0,0,0.2)] backdrop-blur-[4px] flex items-center justify-center">
          {/* Modal */}
          <div className="bg-[#fff] dark:bg-dark-card dark:text-white py-[15px] px-[20px] flex flex-col justify-center shadow-[0px_0px_7px_hsl(0,0%,70%)] rounded-[7px] gap-[20px]">
