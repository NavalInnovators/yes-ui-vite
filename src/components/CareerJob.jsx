  ...
  return (
    <div className="careerJob-page">
      ...
      <div className="header font-header">
        <div className="main-heading">{job.title}</div>
      </div>
      ...
      <div className="career-jobcard">
        <div className="inner-jobcard">
          <div className="btn">
            <button
              className="apply-btn font-black-btn"
              onClick={() =>
          ...
          <div className="section-carrer">
            <div className="section--heading">Roles and Responsibilities</div>
            <ul>
          ...
          <div className="section-carrer">
            <div className="section--heading">Qualifications & Experience</div>
            <ul>
