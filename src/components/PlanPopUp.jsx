...
//         <p className="free-link" onClick={onClose}>
 ...
 *  - .popup-box     : constrained box (max-height) and column flex container
 *    - header (title + close) -- not scrollable
 *    - .popup-content (scrollable area containing the plans)
 *    - footer (free-link) -- not scrollable
 */
function PlanPopup({ onClose }) {
    const navigate = useNavigate();
