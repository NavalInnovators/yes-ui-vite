...
function BookDashboardMidSec({
    ...
    const handleSummarize = async () => {
        ...
        try {
            ...
            const errorMessage =
                err.message || "Failed to summarize the answer";
    ...
    useEffect(() => {
        ...
        const existingSummaries =
            JSON.parse(localStorage.getItem(summaryKey)) || [];
        ...
        const existingRephrased =
            JSON.parse(localStorage.getItem(rephrasedKey)) || [];
                    ...
                    <div className="book-dashboard-summary-answer">
                        <div className="book-dashboard-inner-summary">
                            {summaryLoading ? (
                                ...
                                <div>
                                    Click the summarizer button to generate
                                    summary.
                                </div>
                            )}
                        </div>
                            ...
                            {rephraseLoading ? (
                                ...
                                <>
                                    ...
                                    <div className="summary-pagination-controls">
                                        ...
                                        <span>
                                            {rephraseIndex + 1} /{" "}
                                            {rephrasedList.length} :{" "}
                                            {getStyleLabel(
                                                rephrasedList[rephraseIndex]
                                                    .style,
                                            )}
                                        </span>
                                        <button
